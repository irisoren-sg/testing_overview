...
-   Create ./tests/testthat.R. This is the script that will call all the tests for the package. It refers to the package only and tests are called as per all files in the testthat package
